...
const FAQSection = () => {
  ...
  return (
    <section id="faqs" className="bg-[#05070b] relative z-10 py-24 sm:py-32 px-4 sm:px-6 border-t border-white/[0.06] w-full max-w-full overflow-hidden">
      
      {/* Ambient Background Glows */}
      <div className="absolute top-1/2 left-1/3 -translate-x-1/2 -translate-y-1/2 w-[300px] sm:w-[650px] h-[250px] sm:h-[450px] bg-indigo-600/5 blur-[100px] sm:blur-[160px] rounded-full pointer-events-none z-0" />
