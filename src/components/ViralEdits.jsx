...
const ViralEdits = () => {
  ...
  return (
    <section id="work" className="bg-[#05070b] relative z-10 py-24 sm:py-32 px-4 sm:px-6 border-t border-white/[0.06] w-full max-w-full overflow-hidden">
      
      {/* Ambient background glow */}
      <div className="absolute top-1/2 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[300px] sm:w-[650px] h-[250px] sm:h-[450px] bg-amber-500/5 blur-[100px] sm:blur-[160px] rounded-full pointer-events-none z-0" />
      <div className="absolute bottom-10 right-1/4 w-[300px] sm:w-[550px] h-[250px] sm:h-[380px] bg-indigo-600/5 blur-[100px] sm:blur-[150px] rounded-full pointer-events-none z-0" />
