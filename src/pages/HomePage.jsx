...
const HomePage = () => {
  ...
  return (
    <div className="hero-grid-bg min-h-screen flex flex-col justify-between relative selection:bg-hy-orange selection:text-black overflow-hidden">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center text-center px-6 pt-12 sm:pt-20 pb-16 my-auto">
        ...
        {/* CTA — fade up then float continuously */}
        <div
          className="opacity-0"
